  ...
  <section id="cta" className="py-32 px-6">
    <div className="max-w-4xl mx-auto space-y-16">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Button asChild className="rounded-full px-8 py-4 h-auto font-semibold text-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-500" style={{ background: PRIMARY, boxShadow: `0 0 24px ${PRIMARY}33` }}>
