...
const ECOSYSTEM = [
  ...
  { id: 'O', name: 'Operatist', color: '#f97316', url: 'https://operatist.webchemist.net', current: false },
  { id: 'C', name: 'Curatist', color: '#8b5cf6', url: 'https://curatist.webchemist.net', current: true },
]
